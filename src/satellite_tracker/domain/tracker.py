...
class SatelliteTracker:
    ...
    def __init__(self, satellite: Satrec, observer: Observer):
        ...
        self.obs_ecef = np.array(
            geodetic_to_ecef(self.observer.latitude_rad, self.observer.longitude_rad, self.observer.altitude_m)
        )
    ...
    def get_az_el_range(self, obs_time: datetime | None = None):
        ...
        enu = ecef_to_enu(self.obs_ecef, r_ecef, self.observer.latitude_rad, self.observer.longitude_rad)
